     ...
     <?php 
	  ...
	  ?>
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 ...
        	 <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> KATEGORİ EKLE </h1></div>
        	 ...
        	 <div class="col-xl-4 col-md-6 mx-auto">
                   ...
                   <?php 	
                     switch($veri["kriter"]):
                        ...
                        case "alt":
                           echo '<div class="col-lg-12 col-md-12 col-sm-12 formeleman">';
                           Form::Olustur("2",array("type"=>"text","name"=>"katad","class"=>"form-control m-1"));		
